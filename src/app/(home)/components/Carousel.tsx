...
const Carousel: React.FC<CarouselProps> = ({}) => {
  return (
    ...
    >
      ...
      <SwiperSlide className="px-10 md:px-0">
        <blockquote className="md:text-lg leading-6 max-w-xl mx-auto text-center">
          «Приголомшливий сервіс, допоміг мені за тиждень знайти постійного
          замовника, з яким працюю вже майже 3 роки».
        </blockquote>
        <div className="mt-5 text-gray flex gap-2 items-center justify-center flex-col md:flex-row text-center">
          <Image
      ...
      <SwiperSlide className="px-10 md:px-0">
        <blockquote className="md:text-lg leading-6 max-w-xl mx-auto text-center">
          «Буває, що вам потрібно знайти нову роботу. Джин робить так, щоб
          робота сама вас шукала».
        </blockquote>
        <div className="mt-5 text-gray flex gap-2 items-center justify-center flex-col md:flex-row text-center">
          <Image
      ...
      <SwiperSlide className="px-10 md:px-0">
        <blockquote className="md:text-lg leading-6 max-w-xl mx-auto text-center">
          «Я вже двічі знаходив роботу на Джині і кожного разу все краще :) Так
          тримати!»
        </blockquote>
        <div className="mt-5 text-gray flex gap-2 items-center justify-center flex-col md:flex-row text-center">
          <Image
      ...
      <SwiperSlide className="px-10 md:px-0">
        <blockquote className="md:text-lg leading-6 max-w-xl mx-auto text-center">
          «Джинн - це знахідка. Аналога в Україні немає. Дуже зручний анонімний
          пошук роботи і вакансій».
        </blockquote>
        <div className="mt-5 text-gray flex gap-2 items-center justify-center flex-col md:flex-row text-center">
          <Image
